...
import numpy as np
import AgePensionPayment_PM as AgePensionPayment
...
class RetirementIncome:
    ...
    def __init__(self,name, age, gender, relationship, super_balance, total_testable,
                 ...
                 a_taper_rate, i_taper_rate, asset_limit,
        ...
        self.a_taper_rate = a_taper_rate
        self.i_taper_rate = i_taper_rate
    ...
    def TargetedIncome(self):
        ...
        Life_Style = np.array([[42764.0, 40633.0],[60264.0,56295.0],[27368.0,25841.0],[39353.0,36897.0]])# life standard from ASAF
    ...
    def RISimulation(self):        
        ...
        #a_taper_rate  = self.a_taper_rate
         # 
        ...
        AgePension[:,0], AP_ID[:,0]=AgePensionPayment.AgePension_payment(self.total_testable  , \
                  ...
                  self.Inf_acc[:,0].reshape([self.NumOfSim,1]), self.Wage_acc[:,0].reshape([self.NumOfSim,1]), 0, self.a_taper_rate, self.i_taper_rate)
        ...
        for tt in range(self.NumOfYears-1):
            ...
            AgePension[:,tt+1], AP_ID[:,tt+1] = AgePensionPayment.AgePension_payment(Total_asset_sim[:,tt+1] ,\
                      ...
                      annuity_p, self.gender, self.age, self.relationship, self.home, Inf_acc_t, Wage_acc_t, tt, self.a_taper_rate, self.i_taper_rate)
